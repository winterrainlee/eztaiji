...
舒筋十二式은 2026-09-25 國立東華大學 태극권 동아리에서 직접 촬영한 `太極拳舒筋十二式` 교육자료를 기준으로 12식·38개 세부 동작을 원문 순서대로 제공합니다. 현장 원문은 [`docs/sources/donghwa-shujin12.md`](docs/sources/donghwa-shujin12.md)에 별도로 보존하고, 현재 화면에는 한국어로 옮긴 자료 층만 먼저 연결했습니다. 좌표·허실·신체역학 해석은 원문과 섞지 않고 이후 추가합니다.
