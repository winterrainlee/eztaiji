...
1단 預備式 4동작, 太極起勢 6동작, 攬雀尾 21동작을 시작 상태부터 연결해 제공합니다. 攬雀尾는 左掤 6동·右掤 5동·左履 2동·右擠 3동·雙按 5동의 묶음을 동작 제목에 표시하고, 왼팔·오른팔의 구조적 주방향을 빨간 화살표로 함께 보여줍니다. 좌표·허실·원리·음양·전투 가정은 접근 가능한 자료와 프로젝트 해석을 구분해 표시하며, 나머지 자세는 수집 중입니다. 발 좌표·중심·발끝 각도와 팔 방향은 실측값이 아니라 학습용 근사입니다.
